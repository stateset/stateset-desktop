      ...
      content: (
        <div className="text-center">
          ...
          <p className="text-gray-400 max-w-md mx-auto">
            StateSet runs autonomous AI agents that handle your customer service
            operations 24/7. Connect your platforms and let AI do the work.
          </p>
        </div>
      ),
    },
    {
      ...
      content: (
        <div className="text-center">
          <div className="grid grid-cols-3 gap-4 max-w-sm mx-auto mb-8">
            {[
              ...
              <div
                key={platform.name}
                className={clsx(
                  'p-4 rounded-xl border border-gray-700',
                  platform.color
                )}
              >
          ...
          <p className="text-gray-400 max-w-md mx-auto">
            Connect your e-commerce stack with secure OAuth. Your credentials
    ...
    },
    {
      ...
      content: (
        <div className="text-center">
          ...
          <p className="text-gray-400 max-w-md mx-auto">
            Each agent is specialized for specific tasks and works autonomously
            around the clock.
          </p>
        </div>
      ),
      ...
      content: (
        <div className="text-center">
          ...
          <p className="text-gray-400 max-w-md mx-auto mb-4">
            StateSet runs in your system tray and keeps processing tickets even
            when the window is closed. You'll get notifications for important
            events.
          </p>
  ...
  return (
    <div className="fixed inset-0 bg-gray-950 flex flex-col">
      ...
      <div className="flex items-center justify-between p-6 border-t border-gray-800">
        ...
        <button
          onClick={handleNext}
          className="flex items-center gap-2 px-6 py-2 bg-brand-600 hover:bg-brand-500 rounded-lg font-medium transition-colors"
        >
