        ...
        <div className="p-8">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              ...
              <button
                onClick={handleNext}
                className="flex items-center gap-2 px-5 py-2.5 bg-brand-600 hover:bg-brand-500 rounded-lg font-medium transition-colors"
              >
    ...
    <div className="relative">
      ...
      >
        <div className="flex items-start justify-between gap-2 mb-1">
          ...
          <button onClick={onDismiss} className="text-white/70 hover:text-white text-sm">
            Got it
          </button>
        </div>
